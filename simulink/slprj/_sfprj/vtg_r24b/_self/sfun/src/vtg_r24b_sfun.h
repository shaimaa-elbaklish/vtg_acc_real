#ifndef __vtg_r24b_sfun_h__
#define __vtg_r24b_sfun_h__
...
extern mxArray* load_vtg_r24b_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_vtg_r24b_optimization_info(void);
